...
//        layer.cornerRadius = 10.0
    ...
    func addMaskLayerToVideoPreviewLayerAndAddText(rect: CGRect) {
        ...
        noteText.string = "登录 CNode -> 设置 -> 二维码"
    ...
    private func addButtons(_ view: UIView) {
        ...
        if let cancelImg = cancelImage {
          cancelButton.frame = CGRect(x: view.frame.origin.x, y: view.frame.height - btnWidthWhenCancelImageNil, width: view.frame.width, height: btnWidthWhenCancelImageNil)
